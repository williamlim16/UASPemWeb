            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @if(Auth::id() == 1)
                        <a href="/admin">
                            <button class="btn btn-secondary m-0"
                                    style="padding: 0.375rem 0.75rem;font-size: 0.9rem;line-height: 1.6;text-transform:none; max-width:100%">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item"><img src="{{Auth::user()->profilepath }}" style=" vertical-align: middle;width: 40px;height: 40px;border-radius: 50%;"/></li>
